...
class Campo:
    ...
    def verifica_colisao(self, bola):
        if (bola.pos.y + CONSTS.bolaDiametro/2 >= CONSTS.campoAlt/2) and (CONSTS.velocidade.y > 0):        # A POSITIVO
            CONSTS.normal = glm.vec3(0, 1, 0)
            return True
        elif (bola.pos.y - CONSTS.bolaDiametro/2 <= -CONSTS.campoAlt/2) and (CONSTS.velocidade.y < 0):     # A NEGATIVO
            CONSTS.normal = glm.vec3(0, 1, 0)
            return True
        elif (bola.pos.x + CONSTS.bolaDiametro/2 >= CONSTS.campoLar/2 + 2) and (CONSTS.velocidade.x > 0):  # B POSITIVO
            CONSTS.normal = glm.vec3(1, 0, 0)
            return True
        elif (bola.pos.x - CONSTS.bolaDiametro/2 <= -CONSTS.campoLar/2 - 2) and (CONSTS.velocidade.x < 0): # B NEGATIVO
            CONSTS.normal = glm.vec3(1, 0, 0)
            return True
            ...
            CONSTS.normal = glm.vec3(1, 0, 0)
            return True
        elif (bola.pos.x + CONSTS.bolaDiametro/2 > CONSTS.campoLar/2) and (bola.pos.y - CONSTS.bolaDiametro/2 <= -2.4) and (bola.pos.y - CONSTS.bolaDiametro/2 - CONSTS.velocidade.y > -2.4) and (CONSTS.velocidade.y < 0):    # F POSITIVO
            CONSTS.normal = glm.vec3(0, 1, 0)
            return True
        elif (bola.pos.x - CONSTS.bolaDiametro/2 < -CONSTS.campoLar/2) and (bola.pos.y - CONSTS.bolaDiametro/2 <= -2.4) and (bola.pos.y - CONSTS.bolaDiametro/2 - CONSTS.velocidade.y > -2.4) and (CONSTS.velocidade.y < 0):   # F NEGATIVO
            CONSTS.normal = glm.vec3(0, 1, 0)
            return True
        elif (bola.pos.x + CONSTS.bolaDiametro/2 >= CONSTS.campoLar/2) and (bola.pos.y - CONSTS.bolaDiametro/2 <= -2.4) and (CONSTS.velocidade.x > 0):   # D POSITIVO
            CONSTS.normal = glm.vec3(1, 0, 0)
            return True
        elif (bola.pos.x - CONSTS.bolaDiametro/2 <= -CONSTS.campoLar/2) and (bola.pos.y - CONSTS.bolaDiametro/2 <= -2.4) and (CONSTS.velocidade.x < 0):  # D NEGATIVO
            CONSTS.normal = glm.vec3(1, 0, 0)
            return True
        else:
